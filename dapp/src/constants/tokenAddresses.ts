...
import {address as daiwethpairAddress} from '../sl-sdk/lib/deployments/UniPairFDAIFWETH.json';
import {address as daiwethpoolAddress} from '../sl-sdk/lib/deployments/SLPoolFDAIFWETH.json';
...
export const daiwethpair = daiwethpairAddress;
export const dai = daiAddress;
export const weth = wethAddress;
